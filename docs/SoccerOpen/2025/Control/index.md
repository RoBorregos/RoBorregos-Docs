...
![Image of the coordinate reference for Mirror camera](\assets\soccer\Programming\Normalized_robot_angles.png)
...
![Image of the angle for front camera](\assets\soccer\Programming\Front%20camara_normalized.png)
