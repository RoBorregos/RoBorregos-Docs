...
For starters it is recommended to look at the PlatformIO documentation to correctly install the tool, provided that it is very useful and intuitive to work with.
...
## Resources
Please visit our repository for a complete look at our work:
https://github.com/RoBorregos/Soccer-Vision-2026
